...
public class App {
	...
	public static void main(String[] args) {
		...
		// actorContainer.createActorRef(CustomerActor.class,1);
		//// ActorRef cashierActor =
		// actorContainer.createActorRef(CashierActor.class,2);
...
//		actorContainer.addActorRefToMap(MainWindow.class);
		// String message = "";
